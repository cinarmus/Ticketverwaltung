...
$dest = "../Ticketverwaltung/speicherstände/Ticketsystem";
...
$directory = realpath("../Ticketverwaltung/speicherstände/Ticketsystem");
$options = array("remove_path" => $directory);
$zip->addPattern("/\.(?:json)$/", $directory, $options);
$zip->close();
}
//löscht alle existenten Export-Jsons 
array_map("unlink", glob("../Ticketverwaltung/speicherstände/Ticketsystem/*.json"));
}

//Bilder-Teil Export
if($_POST['Bilder'] == "1"){
try{
            $images_directory="../Ticketverwaltung/images";
...
if($_POST['Dateien'] == "1"){
try{
            $files_directory="../Ticketverwaltung/files";
