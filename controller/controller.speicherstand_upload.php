...
//Lädt Speicherstand-Upload in Speicherstand Ordner
    ...
    move_uploaded_file($tmp_name, "../Ticketverwaltung/speicherstände/Ticketsystem/$name");
    $speicherstandUploadPfad = "../Ticketverwaltung/speicherstände/Ticketsystem/$name";
